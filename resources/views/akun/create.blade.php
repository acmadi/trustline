    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          {!! Form::open(['url' => 'akun/store', 'class' => 'form-horizontal']) !!}
          @if (count($errors) > 0)
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input class="form-control" placeholder="1.11.100.1001" name="no_akun" type="text">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <select class="form-control" name="mata_uang">
                ...
                <option value="{{$currency['simbol']}}">
                  {{$currency['simbol']}} - {{$currency['nama']}}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input class="form-control" placeholder="0" name="saldo_awal" type="text">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <input data-provide="datepicker" class="datepicker form-control" placeholder="2012-12-31" name="tanggal">
              <script>
