    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading">Pengadaan gudang</div>
                <div class="panel-body">
                    {!! Form::open(['url' => 'gudang/store', 'class' => 'form-horizontal']) !!}
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" placeholder="Kode Gudang" name="id" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Nama Gudang</label>
                        <div class="col-md-6">
                            <input class="form-control" placeholder="Nama Gudang" name="nama" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" placeholder="Penanggung Jawab" name="penanggung_jawab" type="text">
                        </div>
                    </div>
                    <div class="form-group">
