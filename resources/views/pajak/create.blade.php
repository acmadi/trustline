        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['url' => 'pajak/store', 'class' => 'form-horizontal']) !!}
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" placeholder="Nilai" name="nilai" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="akun_pajak_penjualan">
                                @foreach($akun as $row)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="akun_pajak_pembelian">
                                @foreach($akun as $row)
                                    <option value="{{$row['no_akun']}}">{{$row['nama']}}</option>
                                @endforeach
                            </select>
