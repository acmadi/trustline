    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading">Masukkan data Syarat Pembayaran</div>
                <div class="panel-body">
                    {!! Form::open(['url' => 'syaratpembayaran/store', 'class' => 'form-horizontal']) !!}
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" name="syarat_diskon" type="text">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" name="jatuh_tempo" type="text">
                        </div>
                        <label class="col-md-2"> hari </label>
                    </div>
                    <div class="form-group">
