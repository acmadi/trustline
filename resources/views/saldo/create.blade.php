        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['url' => 'saldo/store', 'class' => 'form-horizontal']) !!}
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" placeholder="xxxxxxx" name="nomor_bukti" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Kuantitas Awal</label>
                        <div class="col-md-6">
                            <input class="form-control" type="text" placeholder="000" name="kuantitas">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">HPP/Satuan Awal</label>
                        <div class="col-md-6">
                            <input class="form-control" type="text" placeholder="000" name="hpp_satuan">
                        </div>
                    </div>
                    <div class="form-group">
